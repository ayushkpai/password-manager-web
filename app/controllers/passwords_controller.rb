class PasswordsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @password.save
        ...
        format.json { render json: @password.errors, status: :unprocessable_content }
      end
    end
  end
  ...
  def update
    respond_to do |format|
      if @password.update(password_params)
        format.html { redirect_to @password, notice: "Password was successfully updated.", status: :see_other }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to passwords_path, notice: "Password was successfully destroyed.", status: :see_other }
  ...
  private
    ...
    def password_params
      params.expect(password: [ :app, :password ])
    end
end
