...
class PasswordsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create password" do
    assert_difference("Password.count") do
      post passwords_url, params: { password: { app: @password.app, password: @password.password } }
    end
  ...
  test "should update password" do
    patch password_url(@password), params: { password: { app: @password.app, password: @password.password } }
